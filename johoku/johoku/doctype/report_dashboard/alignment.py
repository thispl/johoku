...
def make_xlsx(sheet_name=None):
    ...
    ws["AS1"].value = "Prepared By"
    ws["AX1"].value = "Checked By"
    ws["BB1"].value = "Verified By"
    ws["BG1"].value = "Approved By"
    ...
    ws.merge_cells(start_row=1, start_column=60, end_row=1, end_column=64)
    for row in data:
    ...
    ws.merge_cells(start_row=2, start_column=60, end_row=3, end_column=64)
    ...
    ws.merge_cells(start_row=4, start_column=49, end_row=4, end_column=51)
    ws.merge_cells(start_row=4, start_column=55, end_row=4, end_column=62)
...
def apply_styles(ws):
    ...
    for rows in ws.iter_rows(min_row=1, max_row=2, min_col=45, max_col=64):
        for cell in rows:
            cell.font = header_font
            cell.alignment = align_center
            cell.border = border
    for x in range(2,4):
        for rows in ws.iter_rows(min_row=x, max_row=x, min_col=1, max_col=64):
            for cell in rows:
                cell.font = header_font
                cell.alignment = align_center
                cell.border = border
    ...
    for rows in ws.iter_rows(min_row=4, max_row=5, min_col=26, max_col=35):
        for cell in rows:
            ...
            cell.alignment = align_center
            cell.border = border
    for rows in ws.iter_rows(min_row=4, max_row=5, min_col=62, max_col=64):
        for cell in rows:
            cell.font = text_font_header
            cell.alignment = align_center
            cell.border = border
    ...
    for rows in ws.iter_rows(min_row=4, max_row=4, min_col=46, max_col=48):
        for cell in rows:
            ...
            cell.alignment = align_center
            cell.border = border
    for rows in ws.iter_rows(min_row=4, max_row=4, min_col=49, max_col=51):
        for cell in rows:
            cell.font = text_font_header
            cell.alignment = align_center
            cell.border = border
    for rows in ws.iter_rows(min_row=4, max_row=4, min_col=55, max_col=61):
        for cell in rows:
            cell.font = text_font_header
            cell.alignment = align_center
            cell.border = border
    ...
    for rows in ws.iter_rows(min_row=4, max_row=4, min_col=53, max_col=53):
        for cell in rows:
            ...
            cell.alignment = align_center
            cell.border = border
    for rows in ws.iter_rows(min_row=4, max_row=5, min_col=54, max_col=54):
        for cell in rows:
            cell.font = text_font_header
            cell.alignment = align_center
            cell.border = border
    ...
    for x in range(6,ws.max_row + 1):
        for rows in ws.iter_rows(min_row=x, max_row=x, min_col=4, max_col=64):
            for cell in rows:
    ...
    for rows in ws.iter_rows(min_row=4, max_row=5, min_col=1, max_col=64):
        for cell in rows:
    ...
    for rows in ws.iter_rows(min_row=6, max_row=ws.max_row - 1, min_col=53, max_col=53):
        for cell in rows:
            cell.fill = PatternFill(fgColor="FABF8F", fill_type = "solid")
    for rows in ws.iter_rows(min_row=6, max_row=ws.max_row - 1, min_col=61, max_col=61):
        for cell in rows:
            cell.fill = PatternFill(fgColor="FABF8F", fill_type = "solid")
    for rows in ws.iter_rows(min_row=ws.max_row , max_row=ws.max_row , min_col=1, max_col=64):
        for cell in rows:
            cell.fill = PatternFill(fgColor="f4f087", fill_type = "solid")
            cell.border = border
