...
def get_data():
    ...
    total_others = total_deduction_salary = total_gross_salary = total_net_pay_salary = 0
    ...
    for category in categories:
        ...
        total_other_allow += staff_data[5]
    ...
    total_gross_salary, total_ot, total_att, total_heat, total_tl, total_el, total_other_allow, total_pf,
