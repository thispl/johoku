...
# Convert to datetime object if it's a string
    ...
    data = [
            ...
            ["SALARY STATEMENT FOR THE MONTH OF: " + month_year_format + " - ITI"],
...
""", (from_date, to_date), as_dict=True)
    ...
    for s in salary_slips:
        ...
        components = ['Basic', 'House Rent Allowance', 'Conveyance', 'Education Allowance',
            ...
            'Mobile Allowance', 'Heat Allowance', 'Travel Allowance',
        ...
        if emp.employee_category == "ITI":
            ...
            row += [
                ...
                salary_details['Overtime'],salary_details['Travel Allowance'], 0, 0, 0, 0, total_earnings, salary_details['Provident Fund'],
                salary_details['Employer State Insurance'], salary_details['Professional Tax'], salary_details['Loan'], salary_details['Labour Welfare Fund'],
                salary_details['Others'], total, net_pay]
            data.append(row)
    ...
    row_total += ['Total', '', '', '', '', '', '', '', '', '', '', '', working_days_total, fixed_basic_total, fixed_hra_total, fixed_conveyance_total,
        ...
        0, overtime_total,travel_allow, 0, 0, 0, 0, total_earnings_total, epf_total, esci_total, prof_tax_total, loan_total, lwf_total, others_total, total_total, net_pay_total]
