...
""", (from_date, to_date), as_dict=True)
    ...
    for s in salary_slips:
        ...
        components = ['Basic', 'House Rent Allowance', 'Conveyance', 'Education Allowance',
            ...
            'Overtime','Travel Allowance', 'Attendance Allowance', 'Provident Fund',
        ...
        if emp.employee_category == "DT":
            ...
            row += [
                ...
                salary_details['Medical Re imbursement'], salary_details['Special Allowance'], earned_gross,
                salary_details['Attendance Allowance'], salary_details['Heat Allowance'], 0,
                salary_details['Overtime'], salary_details['Travel Allowance'],0, 0, 0,total_earnings, salary_details['Provident Fund'] ,
            ...
            gross_medical_total += salary_details['Medical Re imbursement']
    ...
    row_total += ['Total', '', '', '', '', '', '', '', '', '', '', '', '', working_days_total, fixed_basic_total, fixed_hra_total, fixed_conveyance_total,
        ...
        0, overtime_total,travel_allow, 0, 0, 0, total_earnings_total, epf_total, esci_total, prof_tax_total, others_total, lwf_total, loan_total,  total_total, net_pay_total]
